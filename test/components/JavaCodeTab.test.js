...
test('JavaCodeTab should render on load', async () => {
    ...
    const expectedCodeSnippet = `import java.io.DataOutputStream;` +
                                ...
                                `  }` +
                                `}​`;
    expect(codeSnippet).toEqual(expectedCodeSnippet);
...
test('JavaCodeTab should render POST request code', async () => {
    ...
    const expectedCodeSnippet = `import java.io.DataOutputStream;` +
                                ...
                                ` catch (Exception e) {` +
                                `      // TODO: handle exception`;
    expect(codeSnippet).toBe(expectedCodeSnippet);

}, 30000);

// TODO: Need to add e2e tests for javacode tab
